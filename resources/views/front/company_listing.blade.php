                    ...
                    <form action="{{ url('company-listing') }}" method="get">
                        ...
                        <div class="widget">
                            ...
                            <select name="founded" class="form-control select2">
                                ...
                                @for($i=1900;$i<=date('Y');$i++) <option value="{{ $i }}" @if($form_founded==$i) selected @endif>{{ $i }}</option>
                                    @endfor
                            </select>
                        </div>
                ...
                <div class="job">
                    <div class="container">
                        <div class="row">
                            ...
                            if ($order_data !== null && isset($order_data->expire_date) && date('Y-m-d') > $order_data->expire_date) {
                            continue;
                            }
                            @endphp
